  ...
  return (
    <section className="relative py-40 px-6 bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <h2 className="headline-font text-4xl md:text-5xl lg:text-6xl text-white/90 mb-10 fade-in leading-tight tracking-wide font-light">
          Ready to start?
          <br />
          <span className="text-neonGreen font-normal">It's time to unlock your <span className="text-neonPink">inner superhero</span>.</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center fade-in">
          <button
            ...
            className="btn-luxury-green flex items-center gap-3 group shadow-2xl text-xs tracking-wider cursor-pointer"
          >
