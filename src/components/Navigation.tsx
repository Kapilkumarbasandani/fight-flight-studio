  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-5">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <Image
              ...
              width={50}
              height={50}
              className="w-10 h-10 sm:w-12 sm:h-12 drop-shadow-[0_0_15px_rgba(57,255,20,0.3)] group-hover:drop-shadow-[0_0_25px_rgba(57,255,20,0.5)] transition-all duration-300"
              style={{ filter: 'brightness(1.15)' }}
            />
            <span className="hidden sm:block headline-font text-lg lg:text-xl text-white font-bold uppercase tracking-wider drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="md:hidden mt-4 space-y-4 pb-2 bg-black/60 backdrop-blur-xl rounded-lg p-4 border border-white/10">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
