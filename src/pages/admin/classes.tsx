...
import { Plus, Edit, Trash2, X, RefreshCcw } from "lucide-react";
...
export default function ClassesManagementPage() {
  const { user: adminUser, loading: authLoading, isAdmin } = useAdminProtection();
  ...
  useEffect(() => {
    if (adminUser && isAdmin) {
      setUser(adminUser as UserResponse);
      fetchClasses(adminUser as UserResponse);
      pollRef.current = setInterval(() => {
        if (adminUser) fetchClasses(adminUser as UserResponse);
      }, 30000);
    }
    return () => {
  ...
  const handleDelete = async (classId: string) => {
    if (!adminUser || !confirm('Are you sure you want to delete this class?')) return;
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => { if (user) fetchClasses(user); }}
                title="Refresh now"
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="flex gap-6 text-sm text-white/60">
                        ...
                        <span>{classItem.capacity - ((classItem as any).enrolled ?? classItem.bookedCount ?? 0)}/{classItem.capacity} spots</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-black/80 border border-white/10 rounded-lg text-white focus:border-neonGreen focus:outline-none cursor-pointer [&::-webkit-calendar-picker-indicator]:invert [&::-webkit-calendar-picker-indicator]:opacity-80"
